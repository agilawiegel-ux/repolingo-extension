...
[English](README.en.md) · [官网](https://agilawiegel-ux.github.io/repolingo-extension/) · [下载](https://github.com/agilawiegel-ux/repolingo-extension/releases/latest) · [隐私](PRIVACY.md) · [安全](SECURITY.md)
...
API Key 只保存在扩展受信任的本地存储中，GitHub 页面和内容脚本无法读取。完整说明见[隐私政策](PRIVACY.md)和[安全政策](SECURITY.md)。
...
- 使用问题与排查：[支持说明](SUPPORT.md)
- 功能建议与 Bug：[Issues](https://github.com/agilawiegel-ux/repolingo-extension/issues)
- 开发计划：[Roadmap](ROADMAP.md)
- 贡献代码或语料：[贡献指南](CONTRIBUTING.md)
- 社区协作规范：[行为准则](CODE_OF_CONDUCT.md)
